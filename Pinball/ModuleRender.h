...
public:
	...
	bool Blit(SDL_Texture* texture, int x, int y, bool fullscreen = false, SDL_Rect* section = NULL, bool invert = false, float speed = 1.0f, double angle = 0, int pivot_x = INT_MAX, int pivot_y = INT_MAX);
