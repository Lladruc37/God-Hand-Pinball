...
// Blit to screen
bool ModuleRender::Blit(SDL_Texture* texture, int x, int y, bool fullscreen, SDL_Rect* section, bool invert, float speed, double angle, int pivot_x, int pivot_y )
{
	bool ret = true;
	uint scale = SCREEN_SIZE;
